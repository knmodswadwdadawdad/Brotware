...
['mobile.css','mobile-fix.css','mobile-touch-ui.css','event-sketchware.css','sketchware-logic.css','sketchware-logic-fix.css','alignment-guides.css','project-workspace.css','sketchware-size-dialog.css','sketchware-gravity-dialog.css','configuration-manager.css','sketchware-image-resource-dialog.css','dialogs-system.css','dialogs-editor-fix.css','dialog-view-blocks.css','view-selector.css','layers-system.css','mobile-workspace-v2.css','mobile-properties-v2.css','mobile-quick-properties.css','color-picker.css','mobile-zoom-controls.css','numeric-property-dialogs.css'].forEach(function(href){
